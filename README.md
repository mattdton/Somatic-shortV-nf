...
A directory called `intervals_folder` is created immediately inside the results directory and it contains all interval files created for the `mutect2` scatter-gather step.
